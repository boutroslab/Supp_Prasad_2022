...
dds_4µ8C_experiment <- DESeqDataSetFromMatrix(star_data_4µ8C_experiment, sampleTable_4µ8C_experiment, ~virus)
...
ggsave(c,filename = "../plots/PCA_pre_batch_correct_dds_4µ8C_experiment.pdf")
...
x4µ8C_over_Mock <- results(dds,contrast = c("virus","4µ8C","Mock"))
...
plotCounts(dds, gene = "ENSG00000204872", intgroup = c("virus"),returnData = F) 
...
ggsave("../plots/star_top_up-regulated_genes_x4µ8C_over_Mock.pdf")

## plot to canvas
reduce(c(count_plots_down), `+`) + plot_layout(ncol = 5, nrow = 4)

ggsave("../plots/star_top_down-regulated_genes_x4µ8C_over_Mock.pdf")
...
ggsave("../plots/star_enriched_GO_signatures_Cov2_shared_4µ8C_positive.pdf")
...
ggsave("../plots/star_enriched_GO_signatures_Cov2_shared_4µ8C_negative.pdf")
